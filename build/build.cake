...
#tool nuget:?package=MSTest.TestAdapter&version=2.2.5-preview-20210625-07
...
public string getMSTestAdapterPath(){
    ...
    if(nugetPaths.Count == 0){
        throw new Exception(
            ...
            "You might need to add '#tool nuget:?package=MSTest.TestAdapter&version=2.2.5-preview-20210625-07' " +
