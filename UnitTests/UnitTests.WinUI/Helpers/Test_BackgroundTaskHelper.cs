...
namespace UnitTests.Helpers
{
    ...
    {
        private const string FakeBackgroundTaskEntryPoint = "UnitTests.WinUI.BackgroundTasks.FakeTestBackgroundTask";
        ...
        {
            Assert.IsNotNull(BackgroundTaskHelper.Register("TaskName", FakeBackgroundTaskEntryPoint, new TimeTrigger(15, true)));
        }
        ...
        {
            Assert.IsNotNull(BackgroundTaskHelper.Register("TaskName", FakeBackgroundTaskEntryPoint, new TimeTrigger(15, true), false, true, new SystemCondition(SystemConditionType.InternetAvailable), new SystemCondition(SystemConditionType.UserPresent)));
        }
        ...
        {
            BackgroundTaskHelper.Register("TaskName", FakeBackgroundTaskEntryPoint, new TimeTrigger(15, true));
        ...
        {
            BackgroundTaskRegistration registeredTask = BackgroundTaskHelper.Register("TaskName", FakeBackgroundTaskEntryPoint, new TimeTrigger(15, true));
