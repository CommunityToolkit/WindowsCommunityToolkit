...
namespace Microsoft.Toolkit.HighPerformance
{
    ...
    public readonly ref struct NullableReadOnlyByReference<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableReadOnlyByReference{T}"/> struct.
        /// </summary>
        /// <param name="value">The readonly reference to the target <typeparamref name="T"/> value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NullableReadOnlyByReference(in T value)
        {
        ...
        /// <summary>
        /// Gets a value indicating whether or not the current <see cref="NullableReadOnlyByReference{T}"/> instance wraps a valid reference that can be accessed.
        /// </summary>
        public bool HasValue
        {
            ...
            get
            {
                // See comment in NullableByReference<T> about this
        ...
        /// <summary>
        /// Gets the <typeparamref name="T"/> reference represented by the current <see cref="NullableReadOnlyByReference{T}"/> instance.
        /// </summary>
