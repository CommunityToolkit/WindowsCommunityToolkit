...
namespace CommunityToolkit.Common.Parsers.Markdown.Inlines
{
    ...
    public class ImageInline : MarkdownInline, IInlineLeaf
    {
        ...
        /// <summary>
        /// Attempts to parse an image e.g. "![Toolkit logo](https://raw.githubusercontent.com/CommunityToolkit/WindowsCommunityToolkit/master/CommunityToolkit.WinUI.SampleApp/Assets/ToolkitLogo.png)".
        /// </summary>
