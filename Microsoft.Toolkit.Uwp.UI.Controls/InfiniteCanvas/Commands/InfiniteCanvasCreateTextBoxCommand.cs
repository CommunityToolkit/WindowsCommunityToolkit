...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
    internal class InfiniteCanvasCreateTextBoxCommand : IInfiniteCanvasCommand
    {
        ...
        public InfiniteCanvasCreateTextBoxCommand(List<IDrawable> drawableList, float x, float y, float width, float height, int textFontSize, string text, Color color, bool isBold, bool isItalic)
        {
