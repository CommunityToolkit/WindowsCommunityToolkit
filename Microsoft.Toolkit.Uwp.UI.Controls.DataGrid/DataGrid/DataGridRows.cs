    ...
    public partial class DataGrid
    {
        ...
        private double EdgedRowsHeightCalculated
        {
            get
            {
                ...
                System.Diagnostics.Debug.Assert(this.DisplayData.LastScrollingSlot >= 0, "Expected positive DisplayData.LastScrollingSlot.");
                System.Diagnostics.Debug.Assert(_verticalOffset >= 0, "Expected positive _verticalOffset.");
                System.Diagnostics.Debug.Assert(this.NegVerticalOffset >= 0, "Expected positive NegVerticalOffset.");
        ...
        {
            System.Diagnostics.Debug.Assert(rowIndex != -1, "Expected rowIndex other than -1.");
        ...
        {
            System.Diagnostics.Debug.Assert(slot != -1, "Expected slot other than -1.");
            ...
            bool isCollapsed)
        {
            ...
            System.Diagnostics.Debug.Assert(slot <= this.SlotCount, "Expected slot smaller than or equal to SlotCount.");
        ...
        {
            System.Diagnostics.Debug.Assert(rowIndex >= 0, "Expected positive rowIndex.");
            System.Diagnostics.Debug.Assert(rowIndex < this.SlotCount, "Expected rowIndex smaller than SlotCount.");
        ...
        {
            System.Diagnostics.Debug.Assert(groupHeader.RowGroupInfo.CollectionViewGroup.GroupItems.Count > 0, "Expected positive groupHeader.RowGroupInfo.CollectionViewGroup.GroupItems.Count.");
        ...
        {
            System.Diagnostics.Debug.Assert(this.DataConnection.CollectionView != null, "Expected non-null DataConnection.CollectionView.");
            System.Diagnostics.Debug.Assert(this.DataConnection.CollectionView.CollectionGroups != null, "Expected non-null DataConnection.CollectionView.CollectionGroups.");
            System.Diagnostics.Debug.Assert(this.RowGroupSublevelIndents != null, "Expected non-null RowGroupSublevelIndents.");
...
#endif
            System.Diagnostics.Debug.Assert(groupHeader.Level >= 0, "Expected positive groupHeader.Level.");
            System.Diagnostics.Debug.Assert(groupHeader.Level < groupLevelCount, "Expected groupHeader.Level smaller than groupLevelCount.");
            ...
            for (int i = groupHeader.Level; i < groupLevelCount; i++)
            {
                ...
                System.Diagnostics.Debug.Assert(this.RowGroupSublevelIndents[i] >= 0, "Expected positive RowGroupSublevelIndents[i].");
            }
        ...
        {
            System.Diagnostics.Debug.Assert(_collapsedSlotsTable.Contains(slot) || !IsSlotOutOfBounds(slot), "Expected _collapsedSlotsTable.Contains(slot) is true or IsSlotOutOfBounds(slot) is false.");
            ...
            System.Diagnostics.Debug.Assert(DoubleUtil.LessThanOrClose(this.NegVerticalOffset, _verticalOffset), "Expected NegVerticalOffset is less than or close to _verticalOffset.");
        ...
        {
            System.Diagnostics.Debug.Assert(isSelected || !setAnchorSlot, "Expected isSelected is true or setAnchorSlot is false.");
            System.Diagnostics.Debug.Assert(!IsSlotOutOfSelectionBounds(slot), "Expected IsSlotOutOfSelectionBounds(slot) is false.");
            _noSelectionChangeCount++;
            try
            {
                if (this.SelectionMode == DataGridSelectionMode.Single && isSelected)
                {
                    System.Diagnostics.Debug.Assert(_selectedItems.Count <= 1, "Expected _selectedItems.Count smaller than or equal to 1.");
                    if (_selectedItems.Count > 0)
                    {
                        int currentlySelectedSlot = _selectedItems.GetIndexes().First();
        ...
        {
            System.Diagnostics.Debug.Assert(startSlot >= 0, "Expected startSlot is positive.");
            System.Diagnostics.Debug.Assert(startSlot < this.SlotCount, "Expected startSlot is smaller than SlotCount.");
            System.Diagnostics.Debug.Assert(endSlot >= 0, "Expected endSlot is positive.");
            System.Diagnostics.Debug.Assert(endSlot < this.SlotCount, "Expected endSlot is smaller than SlotCount.");
            System.Diagnostics.Debug.Assert(startSlot <= endSlot, "Expected startSlot is smaller than or equal to endSlot.");
        ...
        private void AddSlotElement(int slot, UIElement element)
        {
            ...
            if (row != null)
            {
                System.Diagnostics.Debug.Assert(row.OwningGrid == this, "Expected row.OwningGrid equals this DataGrid.");
                System.Diagnostics.Debug.Assert(row.Cells.Count == this.ColumnsItemsInternal.Count, "Expected row.Cells.Count equals this.ColumnsItemsInternal.Count.");

                int columnIndex = 0;
                foreach (DataGridCell dataGridCell in row.Cells)
                {
                    System.Diagnostics.Debug.Assert(dataGridCell.OwningRow == row, "Expected dataGridCell.OwningRow equals row.");
                    System.Diagnostics.Debug.Assert(dataGridCell.OwningColumn == this.ColumnsItemsInternal[columnIndex], "Expected dataGridCell.OwningColumn equals this.ColumnsItemsInternal[columnIndex].");
                    columnIndex++;
                }
            }
#endif
            System.Diagnostics.Debug.Assert(slot == this.SlotCount, "Expected slot equals this.SlotCount.");
        ...
        private void ApplyDisplayedRowsState(int startSlot, int endSlot)
        {
            ...
            if (firstSlot >= 0)
            {
                System.Diagnostics.Debug.Assert(lastSlot >= firstSlot, "lastSlot greater than or equal to firstSlot.");
        ...
        {
            System.Diagnostics.Debug.Assert(slotDeleted >= 0, "Expected positive slotDeleted.");
        ...
        {
            System.Diagnostics.Debug.Assert(slotInserted >= 0, "Expected positive slotInserted.");
        ...
        {
            System.Diagnostics.Debug.Assert(e.OldItems.Count == 1, "Expected e.OldItems.Count equals 1.");
        ...
        private int GetDetailsCountInclusive(int lowerBound, int upperBound)
        {
            ...
            System.Diagnostics.Debug.Assert(false, "Expected known RowDetailsVisibilityMode value."); // Shouldn't ever happen
            return 0;
        }
        ...
        private void EnsureRowGroupVisibility(DataGridRowGroupInfo rowGroupInfo, Visibility visibility, bool setCurrent)
        {
            ...
            if (rowGroupInfo.Visibility != visibility)
            {
                ...
                {
                    DataGridRowGroupHeader rowGroupHeader = this.DisplayData.GetDisplayedElement(rowGroupInfo.Slot) as DataGridRowGroupHeader;
                    System.Diagnostics.Debug.Assert(rowGroupHeader != null, "Expected non-null rowGroupHeader.");
        ...
        private void GenerateEditingElements()
        {
            ...
            {
                System.Diagnostics.Debug.Assert(this.EditingRow.Cells.Count == this.ColumnsItemsInternal.Count, "Expected EditingRow.Cells.Count equals this.ColumnsItemsInternal.Count.");
...
#if FEATURE_ICOLLECTIONVIEW_GROUP
            System.Diagnostics.Debug.Assert(this.DataConnection.CollectionView != null && groupHeader.Level < this.DataConnection.CollectionView.GroupDescriptions.Count);
        ...
        {
            System.Diagnostics.Debug.Assert(slot >= 0, "Expected positive slot.");
            System.Diagnostics.Debug.Assert(slot < this.SlotCount, "Expected slot  smaller than SlotCount.");

            if (this.IsSlotVisible(slot))
            {
                System.Diagnostics.Debug.Assert(this.DisplayData.GetDisplayedElement(slot) != null, "Expected non-null DisplayData.GetDisplayedElement(slot).");
            ...
            System.Diagnostics.Debug.Assert(slotElement != null, "Expected non-null slotElement.");
        ...
        {
            System.Diagnostics.Debug.Assert(toSlot >= fromSlot, "Expected toSlot greater or equal to fromSlot.");
            ...
            if (_rowsPresenter != null)
            {
                ...
                if (row != null)
                {
                    ...
                    if (IsRowRecyclable(row))
                    {
                        if (!row.IsRecycled)
                        {
                            System.Diagnostics.Debug.Assert(!_rowsPresenter.Children.Contains(element), "Expected element not contained in _rowsPresenter.Children.");
                    ...
                    {
                        element.Clip = null;
                        System.Diagnostics.Debug.Assert(row.Index == RowIndexFromSlot(slot), "Expected row.Index equals RowIndexFromSlot(slot).");
                ...
                else
                {
                    ...
                    System.Diagnostics.Debug.Assert(groupHeader != null, "Expected non-null grouHeader.");
                    if (groupHeader != null)
                    {
        ...
        private void OnCollectionViewGroupItemRemoved(object groupItems, object removedItem, int removedIndex)
        {
            ...
            if (removedGroup != null)
            {
                ...
                System.Diagnostics.Debug.Assert(groupInfo != null, "Expected non-null groupInfo.");
                if ((groupInfo.Level == _rowGroupHeightsByLevel.Length - 1) && (removedGroup.GroupItems != null) && (removedGroup.GroupItems.Count > 0))
                {
                    System.Diagnostics.Debug.Assert(groupInfo.LastSubItemSlot - groupInfo.Slot == removedGroup.GroupItems.Count, "Expected groupInfo.LastSubItemSlot - groupInfo.Slot equals removedGroup.GroupItems.Count.");
        ...
        private void OnInsertedElement_Phase1(int slot, UIElement element, bool isCollapsed, bool isRow)
        {
            ...
            if (element != null)
            {
                ...
                if (dataGridRow != null)
                {
                    System.Diagnostics.Debug.Assert(dataGridRow.Cells.Count == this.ColumnsItemsInternal.Count, "Expected dataGridRow.Cells.Count equals ColumnsItemsInternal.Count.");

                    int columnIndex = 0;
                    foreach (DataGridCell dataGridCell in dataGridRow.Cells)
                    {
                        System.Diagnostics.Debug.Assert(dataGridCell.OwningRow == dataGridRow, "Expected dataGridRow owns dataGridCell.");
                        System.Diagnostics.Debug.Assert(dataGridCell.OwningColumn == this.ColumnsItemsInternal[columnIndex], "Expected ColumnsItemsInternal[columnIndex] owns dataGridCell.");
                        columnIndex++;
                    }
                }
#endif
                System.Diagnostics.Debug.Assert(!isCollapsed, "Expected isCollapsed is false.");
                OnAddedElement_Phase1(slot, element);
            }
        ...
        {
            System.Diagnostics.Debug.Assert(slot >= 0, "Expected positve slot.");
        ...
        private void OnInsertingElement(int slotInserted, bool firstInsertion, bool isCollapsed, bool isRow)
        {
            ...
            if (firstInsertion)
            {
                if (this.CurrentSlot != -1 && slotInserted <= this.CurrentSlot)
                {
                    ...
                    System.Diagnostics.Debug.Assert(success, "Expected successful SetCurrentCellCore call.");
                }
            }
        ...
        private void OnRemovingElement(int slotDeleted)
        {
            ...
            System.Diagnostics.Debug.Assert(slotDeleted >= 0, "Expected positive slotDeleted.");
            System.Diagnostics.Debug.Assert(slotDeleted < this.SlotCount, "Expected slotDeleted smaller than SlotCount.");
        ...
        {
            System.Diagnostics.Debug.Assert(slot >= this.DisplayData.FirstScrollingSlot, "Expected slot larger or equal to DisplayData.FirstScrollingSlot.");
            System.Diagnostics.Debug.Assert(slot <= this.DisplayData.LastScrollingSlot, "Expected slot smaller or equal to DisplayData.LastScrollingSlot.");
        ...
        private void RemoveEditingElements()
        {
            if (this.EditingRow != null && this.EditingRow.Cells != null)
            {
                System.Diagnostics.Debug.Assert(this.EditingRow.Cells.Count == this.ColumnsItemsInternal.Count, "Expected EditingRow.Cells.Count equals ColumnsItemsInternal.Count.");
        ...
        {
            System.Diagnostics.Debug.Assert(this.DisplayData.FirstScrollingSlot >= 0, "Expected positive DisplayData.FirstScrollingSlot.");
            System.Diagnostics.Debug.Assert(!DoubleUtil.IsZero(height), "DoubleUtil.IsZero(height) is false.");
            ...
            try
            {
                ...
                if (DoubleUtil.LessThan(firstRowHeight, this.NegVerticalOffset))
                {
                    ...
                    {
                        newFirstScrollingSlot = GetNextVisibleSlot(newFirstScrollingSlot);
                        System.Diagnostics.Debug.Assert(newFirstScrollingSlot != -1, "Expected newFirstScrollingSlot other than -1.");
                    }
                ...
                System.Diagnostics.Debug.Assert(this.DisplayData.FirstScrollingSlot >= 0, "Expected positive DisplayData.FirstScrollingSlot.");
                System.Diagnostics.Debug.Assert(GetExactSlotElementHeight(this.DisplayData.FirstScrollingSlot) > this.NegVerticalOffset, "Expected GetExactSlotElementHeight(DisplayData.FirstScrollingSlot) larger than this.NegVerticalOffset.");
                ...
                System.Diagnostics.Debug.Assert(DoubleUtil.GreaterThanOrClose(this.NegVerticalOffset, 0), "Expected NegVerticalOffset greater than or close to 0.");
                System.Diagnostics.Debug.Assert(DoubleUtil.GreaterThanOrClose(_verticalOffset, this.NegVerticalOffset), "Expected _verticalOffset greater than or close to NegVerticalOffset.");
        ...
        {
            System.Diagnostics.Debug.Assert(IsSlotVisible(slot), "Expected IsSlotVisible(slot) is true.");
        ...
        private void UnloadRow(DataGridRow dataGridRow)
        {
            ...
            System.Diagnostics.Debug.Assert(_rowsPresenter != null, "Expected non-null _rowsPresenter.");
            System.Diagnostics.Debug.Assert(_rowsPresenter.Children.Contains(dataGridRow), "Expected dataGridRow contained in _rowsPresenter.Children.");
        ...
        {
            System.Diagnostics.Debug.Assert(!_collapsedSlotsTable.Contains(newFirstDisplayedSlot), "Expected newFirstDisplayedSlot not contained in _collapsedSlotsTable.");
            ...
            if (visibleScrollingRows == 0)
            {
                ...
                System.Diagnostics.Debug.Assert(lastDisplayedScrollingSlot == -1, "Expected lastDisplayedScrollingSlot equal to -1.");
            }

            System.Diagnostics.Debug.Assert(lastDisplayedScrollingSlot < this.SlotCount, "lastDisplayedScrollingRow larger than number of rows");

            RemoveNonDisplayedRows(firstDisplayedScrollingSlot, lastDisplayedScrollingSlot);

            System.Diagnostics.Debug.Assert(this.DisplayData.NumDisplayedScrollingElements >= 0, "the number of visible scrolling rows can't be negative");
            System.Diagnostics.Debug.Assert(this.DisplayData.NumTotallyDisplayedScrollingElements >= 0, "the number of totally visible scrolling rows can't be negative");
            System.Diagnostics.Debug.Assert(this.DisplayData.FirstScrollingSlot < this.SlotCount, "firstDisplayedScrollingRow larger than number of rows");
            System.Diagnostics.Debug.Assert(this.DisplayData.FirstScrollingSlot == firstDisplayedScrollingSlot, "Expected DisplayData.FirstScrollingSlot equal to firstDisplayedScrollingSlot.");
            System.Diagnostics.Debug.Assert(this.DisplayData.LastScrollingSlot == lastDisplayedScrollingSlot, "DisplayData.LastScrollingSlot equal to lastDisplayedScrollingSlot.");
        }
        ...
        {
            System.Diagnostics.Debug.Assert(!_collapsedSlotsTable.Contains(newLastDisplayedScrollingRow), "Expected newLastDisplayedScrollingRow not contained in _collapsedSlotsTable.");
            ...
            System.Diagnostics.Debug.Assert(this.DisplayData.NumTotallyDisplayedScrollingElements >= 0, "Expected positive DisplayData.NumTotallyDisplayedScrollingElements.");
            System.Diagnostics.Debug.Assert(lastDisplayedScrollingRow < this.SlotCount, "lastDisplayedScrollingRow larger than number of rows");
        ...
        private double UpdateRowGroupVisibility(DataGridRowGroupInfo targetRowGroupInfo, Visibility newVisibility, bool isHeaderDisplayed)
        {
            ...
            else
            {
                ...
                System.Diagnostics.Debug.Assert(endSlot >= 0, "Expected positive endSlot.");
                foreach (int slot in this.RowGroupHeadersTable.GetIndexes(targetRowGroupInfo.Slot + 1))
                {
                    DataGridRowGroupInfo rowGroupInfo = this.RowGroupHeadersTable.GetValueAt(slot);
                    if (rowGroupInfo.Level <= targetRowGroupInfo.Level)
                ...
                if (isHeaderDisplayed || onlyChildrenDisplayed)
                {
                    ...
                    {
                        System.Diagnostics.Debug.Assert(this.EditingRow == null, "Expected null EditingRow.");
                ...
                if (this.DisplayData.FirstScrollingSlot >= startSlot && this.DisplayData.FirstScrollingSlot <= endSlot)
                {
                    ...
                    System.Diagnostics.Debug.Assert(collapsedSlotsAbove > 0, "Expected positive collapsedSlotsAbove.");
