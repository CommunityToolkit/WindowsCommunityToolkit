        ...
        namespace Uwp
        {
            namespace UI
            {
                namespace Controls
                {
                    namespace WinRT
                    {
                        namespace Microsoft_Toolkit_Uwp_UI_Controls_WinRT_XamlTypeInfo
                        {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::Microsoft::Toolkit::Uwp::UI::Controls::WinRT::Microsoft_Toolkit_Uwp_UI_Controls_WinRT_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::Microsoft::Toolkit::Uwp::UI::Controls::WinRT::Microsoft_Toolkit_Uwp_UI_Controls_WinRT_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::Microsoft::Toolkit::Uwp::UI::Controls::WinRT::Microsoft_Toolkit_Uwp_UI_Controls_WinRT_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::Microsoft::Toolkit::Uwp::UI::Controls::WinRT::Microsoft_Toolkit_Uwp_UI_Controls_WinRT_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
