...
![Scale Behavior animation](https://github.com/Vijay-Nirmal/UWPCommunityToolkit/blob/DocImprovements/docs/resources/images/Animations/Fade/Sample-Output.gif)
...
- Use this to create popup effect
    ...
    **Sample Output**
    ...
    ![Use Case 1 Output](https://github.com/Vijay-Nirmal/UWPCommunityToolkit/blob/DocImprovements/docs/resources/images/Animations/Saturation/Scale.gif)
