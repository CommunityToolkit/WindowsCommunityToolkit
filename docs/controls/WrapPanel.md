...
Spacing can be automatically added between items using the HorizontalSpacing and VerticalSpacing properties. When the Orientation is Horizontal, HorizontalSpacing adds uniform spacing horizontal spacing between each horizontal item, and VerticalSpacing adds uniform spacing between each row of items.
