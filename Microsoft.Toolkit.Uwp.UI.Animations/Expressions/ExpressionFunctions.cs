...
namespace Microsoft.Toolkit.Uwp.UI.Animations.Expressions
{
    ...
    public static class ExpressionFunctions
    {
        ...
        public static ScalarNode ATan(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Atan, val); }
        ...
        public static ScalarNode Ceil(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Ceil, val); }

        /// <summary> Returns the cosine of the specified angle (in radians) </summary>
        /// <param name="val">An angle, measured in radians.</param>
        public static ScalarNode Cos(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Cos, val); }

        /// <summary> Returns the largest integer less than or equal to the specified value. </summary>
        /// <param name="val">The floating point number to round.</param>
        public static ScalarNode Floor(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Floor, val); }
        ...
        public static ScalarNode Ln(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Ln, val); }

        /// <summary> Returns the base 10 logarithm of a specified number. </summary>
        /// <param name="val">The number whose base 10 logarithm is to be calculated.</param>
        public static ScalarNode Log10(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Log10, val); }
        ...
        public static ScalarNode Pow(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Pow, val1, val2); }

        /// <summary> Rounds a floating point value to the nearest integral value. </summary>
        /// <param name="val">The floating point number to round.</param>
        public static ScalarNode Round(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Round, val); }

        /// <summary> Returns the sine of the specified angle (in radians) </summary>
        /// <param name="val">An angle, measured in radians.</param>
        public static ScalarNode Sin(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Sin, val); }
        ...
        public static ScalarNode Square(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Square, val); }

        /// <summary> Returns the square root of a specified number. </summary>
        /// <param name="val">The number whose square root is to be returned.</param>
        public static ScalarNode Sqrt(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Sqrt, val); }

        /// <summary> Returns the tangent of the specified angle (in radians) </summary>
        /// <param name="val">An angle, measured in radians.</param>
        public static ScalarNode Tan(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Tan, val); }
        ...
        public static ScalarNode ToDegrees(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.ToDegrees, val); }
        ...
        public static ScalarNode ToRadians(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.ToRadians, val); }
        ...
        public static ScalarNode Abs(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Absolute, val); }
        ...
        public static Vector4Node Abs(Vector4Node val) { return Function<Vector4Node>(ExpressionNodeType.Absolute, val); }
        ...
        public static ScalarNode Clamp(ScalarNode val, ScalarNode min, ScalarNode max) { return Function<ScalarNode>(ExpressionNodeType.Clamp, val, min, max); }
        ...
        public static Vector4Node Clamp(Vector4Node val, Vector4Node min, Vector4Node max) { return Function<Vector4Node>(ExpressionNodeType.Clamp, val, min, max); }
        ...
        public static ColorNode ColorLerp(ColorNode val1, ColorNode val2, ScalarNode progress) { return Function<ColorNode>(ExpressionNodeType.ColorLerp, val1, val2, progress); }

        /// <summary> Linearly interpolates between two colors in the HSL color space. </summary>
        /// <param name="val1">Color source value 1.</param>
        /// <param name="val2">Color source value 2.</param>
        /// <param name="progress">A value between 0 and 1.0 indicating the weight of val2.</param>
        public static ColorNode ColorLerpHsl(ColorNode val1, ColorNode val2, ScalarNode progress) { return Function<ColorNode>(ExpressionNodeType.ColorLerpHsl, val1, val2, progress); }

        /// <summary> Linearly interpolates between two colors in the RBG color space. </summary>
        /// <param name="val1">Color source value 1.</param>
        /// <param name="val2">Color source value 2.</param>
        /// <param name="progress">A value between 0 and 1.0 indicating the weight of val2.</param>
        public static ColorNode ColorLerpRgb(ColorNode val1, ColorNode val2, ScalarNode progress) { return Function<ColorNode>(ExpressionNodeType.ColorLerpRgb, val1, val2, progress); }
        ...
        public static QuaternionNode Concatenate(QuaternionNode val1, QuaternionNode val2) { return Function<QuaternionNode>(ExpressionNodeType.Concatenate, val1, val2); }
        ...
        public static ScalarNode Distance(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Distance, val1, val2); }
        public static ScalarNode Distance(Vector2Node val1, Vector2Node val2) { return Function<ScalarNode>(ExpressionNodeType.Distance, val1, val2); }
        public static ScalarNode Distance(Vector3Node val1, Vector3Node val2) { return Function<ScalarNode>(ExpressionNodeType.Distance, val1, val2); }
        public static ScalarNode Distance(Vector4Node val1, Vector4Node val2) { return Function<ScalarNode>(ExpressionNodeType.Distance, val1, val2); }

        /// <summary> Returns the squared distance between two vectors as: ((x1-x2)^2 + (y1-y2)^2 + ...). </summary>
        /// <param name="val1">Source value 1.</param>
        /// <param name="val2">Source value 2.</param>
        public static ScalarNode DistanceSquared(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.DistanceSquared, val1, val2); }
        ...
        public static ScalarNode DistanceSquared(Vector4Node val1, Vector4Node val2) { return Function<ScalarNode>(ExpressionNodeType.DistanceSquared, val1, val2); }

        /// <summary> Returns the inverse of the specified matrix. </summary>
        /// <param name="val">The matrix to invert.</param>
        public static Matrix3x2Node Inverse(Matrix3x2Node val) { return Function<Matrix3x2Node>(ExpressionNodeType.Inverse, val); }
        public static Matrix4x4Node Inverse(Matrix4x4Node val) { return Function<Matrix4x4Node>(ExpressionNodeType.Inverse, val); }
        ...
        public static ScalarNode Length(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.Length, val); }
        public static ScalarNode Length(Vector2Node val) { return Function<ScalarNode>(ExpressionNodeType.Length, val); }
        public static ScalarNode Length(Vector3Node val) { return Function<ScalarNode>(ExpressionNodeType.Length, val); }
        public static ScalarNode Length(Vector4Node val) { return Function<ScalarNode>(ExpressionNodeType.Length, val); }
        public static ScalarNode Length(QuaternionNode val) { return Function<ScalarNode>(ExpressionNodeType.Length, val); }
        ...
        public static ScalarNode LengthSquared(ScalarNode val) { return Function<ScalarNode>(ExpressionNodeType.LengthSquared, val); }
        ...
        public static ScalarNode LengthSquared(Vector4Node val) { return Function<ScalarNode>(ExpressionNodeType.LengthSquared, val); }
        public static ScalarNode LengthSquared(QuaternionNode val) { return Function<ScalarNode>(ExpressionNodeType.LengthSquared, val); }

        /// <summary> Linearly interpolates between two vectors as: Output.x = x1 + (x2-x1)*progress </summary>
        /// <param name="val1">Source value 1.</param>
        /// <param name="val2">Source value 2.</param>
        /// <param name="progress">A value between 0 and 1.0 indicating the weight of val2.</param>
        public static ScalarNode Lerp(ScalarNode val1, ScalarNode val2, ScalarNode progress) { return Function<ScalarNode>(ExpressionNodeType.Lerp, val1, val2, progress); }
        ...
        public static Vector4Node Lerp(Vector4Node val1, Vector4Node val2, ScalarNode progress) { return Function<Vector4Node>(ExpressionNodeType.Lerp, val1, val2, progress); }

        /// <summary> Returns the maximum of two values. For vectors, the max of each subchannel is returned. </summary>
        /// <param name="val1">Source value 1.</param>
        /// <param name="val2">Source value 2.</param>
        public static ScalarNode Max(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Max, val1, val2); }
        public static Vector2Node Max(Vector2Node val1, Vector2Node val2) { return Function<Vector2Node>(ExpressionNodeType.Max, val1, val2); }
        public static Vector3Node Max(Vector3Node val1, Vector3Node val2) { return Function<Vector3Node>(ExpressionNodeType.Max, val1, val2); }
        public static Vector4Node Max(Vector4Node val1, Vector4Node val2) { return Function<Vector4Node>(ExpressionNodeType.Max, val1, val2); }

        /// <summary> Returns the minimum of two values. For vectors, the min of each subchannel is returned. </summary>
        /// <param name="val1">Source value 1.</param>
        /// <param name="val2">Source value 2.</param>
        public static ScalarNode Min(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Min, val1, val2); }
        public static Vector2Node Min(Vector2Node val1, Vector2Node val2) { return Function<Vector2Node>(ExpressionNodeType.Min, val1, val2); }
        public static Vector3Node Min(Vector3Node val1, Vector3Node val2) { return Function<Vector3Node>(ExpressionNodeType.Min, val1, val2); }
        public static Vector4Node Min(Vector4Node val1, Vector4Node val2) { return Function<Vector4Node>(ExpressionNodeType.Min, val1, val2); }
        ...
        public static ScalarNode Mod(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Modulus, val1, val2); }
        ...
        public static Vector4Node Mod(Vector4Node val1, Vector4Node val2) { return Function<Vector4Node>(ExpressionNodeType.Modulus, val1, val2); }

        /// <summary> Returns the normalized version of a vector. </summary>
        /// <param name="val">Vector value to normalize.</param>
        public static Vector2Node Normalize(Vector2Node val) { return Function<Vector2Node>(ExpressionNodeType.Normalize, val); }
        public static Vector3Node Normalize(Vector3Node val) { return Function<Vector3Node>(ExpressionNodeType.Normalize, val); }
        public static Vector4Node Normalize(Vector4Node val) { return Function<Vector4Node>(ExpressionNodeType.Normalize, val); }
        public static QuaternionNode Normalize(QuaternionNode val) { return Function<QuaternionNode>(ExpressionNodeType.Normalize, val); }
        ...
        public static ScalarNode Scale(ScalarNode val1, ScalarNode val2) { return Function<ScalarNode>(ExpressionNodeType.Scale, val1, val2); }
        ...
        public static Vector4Node Scale(Vector4Node val1, ScalarNode val2) { return Function<Vector4Node>(ExpressionNodeType.Scale, val1, val2); }
        public static Matrix3x2Node Scale(Matrix3x2Node val1, ScalarNode val2) { return Function<Matrix3x2Node>(ExpressionNodeType.Scale, val1, val2); }
        public static Matrix4x4Node Scale(Matrix4x4Node val1, ScalarNode val2) { return Function<Matrix4x4Node>(ExpressionNodeType.Scale, val1, val2); }
        ...
        /// <param name="progress">A value between 0 and 1.0 indicating the weight of val2.</param>
        public static QuaternionNode Slerp(QuaternionNode val1, QuaternionNode val2, ScalarNode progress) { return Function<QuaternionNode>(ExpressionNodeType.Slerp, val1, val2, progress); }
        ...
        public static Vector2Node Transform(Vector2Node val1, Matrix3x2Node val2) { return Function<Vector2Node>(ExpressionNodeType.Transform, val1, val2); }
        public static Vector4Node Transform(Vector4Node val1, Matrix4x4Node val2) { return Function<Vector4Node>(ExpressionNodeType.Transform, val1, val2); }
        ...
        public static Vector2Node Vector2(ScalarNode x, ScalarNode y) { return Function<Vector2Node>(ExpressionNodeType.Vector2, x, y); }
        public static Vector3Node Vector3(ScalarNode x, ScalarNode y, ScalarNode z) { return Function<Vector3Node>(ExpressionNodeType.Vector3, x, y, z); }
        public static Vector4Node Vector4(ScalarNode x, ScalarNode y, ScalarNode z, ScalarNode w) { return Function<Vector4Node>(ExpressionNodeType.Vector4, x, y, z, w); }

        /// <summary> Creates a color in the HSL format. </summary>
        /// <param name="h">Hue</param>
        /// <param name="s">Saturation</param>
        /// <param name="l">Luminosity</param>
        public static ColorNode ColorHsl(ScalarNode h, ScalarNode s, ScalarNode l) { return Function<ColorNode>(ExpressionNodeType.ColorHsl, h, s, l); }
        ...
        public static QuaternionNode Quaternion(ScalarNode x, ScalarNode y, ScalarNode z, ScalarNode w) { return Function<QuaternionNode>(ExpressionNodeType.Quaternion, x, y, z, w); }
        ...
        public static Matrix3x2Node CreateTranslation(Vector2Node val) { return Function<Matrix3x2Node>(ExpressionNodeType.Matrix3x2FromTranslation, val); }
        ...
        public static Matrix3x2Node CreateScale(Vector2Node val) { return Function<Matrix3x2Node>(ExpressionNodeType.Matrix3x2FromScale, val); }
        ...
        public static Matrix3x2Node CreateRotation(ScalarNode angle) { return Function<Matrix3x2Node>(ExpressionNodeType.Matrix3x2FromRotation, angle); }
        ...
        public static BooleanNode And(BooleanNode val1, BooleanNode val2) { return Function<BooleanNode>(ExpressionNodeType.And, val1, val2); }

        /// <summary> Performs a logical OR operation on two boolean values as: val1 || val2. </summary>
        public static BooleanNode Or(BooleanNode val1, BooleanNode val2) { return Function<BooleanNode>(ExpressionNodeType.Or, val1, val2); }

        /// <summary> Performs a logical NOT operation on a specified boolean value as: !val. </summary>
        public static BooleanNode Not(BooleanNode val) { return Function<BooleanNode>(ExpressionNodeType.Not, val); }
        ...
        public static ScalarNode Conditional(BooleanNode condition, ScalarNode trueCase, ScalarNode falseCase) { return Function<ScalarNode>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
        ...
        public static Vector4Node Conditional(BooleanNode condition, Vector4Node trueCase, Vector4Node falseCase) { return Function<Vector4Node>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
        public static ColorNode Conditional(BooleanNode condition, ColorNode trueCase, ColorNode falseCase) { return Function<ColorNode>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
        public static QuaternionNode Conditional(BooleanNode condition, QuaternionNode trueCase, QuaternionNode falseCase) { return Function<QuaternionNode>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
        public static Matrix3x2Node Conditional(BooleanNode condition, Matrix3x2Node trueCase, Matrix3x2Node falseCase) { return Function<Matrix3x2Node>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
        public static Matrix4x4Node Conditional(BooleanNode condition, Matrix4x4Node trueCase, Matrix4x4Node falseCase) { return Function<Matrix4x4Node>(ExpressionNodeType.Conditional, condition, trueCase, falseCase); }
