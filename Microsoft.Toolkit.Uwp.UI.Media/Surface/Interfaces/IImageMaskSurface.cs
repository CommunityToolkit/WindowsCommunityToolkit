...
namespace Microsoft.Toolkit.Uwp.UI.Media.Surface
{
    ...
    {
        /// <summary>
        /// Gets the padding between the IImageMaskSurface outer bounds and the bounds of the area where the mask, created from the loaded image's alpha values, should be rendered.
        /// </summary>
        ...
        /// <summary>
        /// Redraws the IImageMaskSurface using the given CanvasBitmap's alpha values with the given padding using the given options.
        /// </summary>
        /// <param name="imageSurface">ImageSurface whose image's alpha values are to be used to create the mask.</param>
        /// <param name="padding">
        /// The padding between the IImageMaskSurface outer bounds and the bounds of the area where the mask, created from the loaded image's alpha values, should be rendered.
        ...
        /// <summary>
        /// Redraws the IImageMaskSurface using the alpha values of the image in the given IImageMaskSurface with the given padding and options.
        /// </summary>
        /// <param name="imageMaskSurface">IImageMaskSurface whose image's alpha values are to be used to create the mask.</param>
        /// <param name="padding">
        /// The padding between the IImageMaskSurface outer bounds and the bounds of the area where the mask, created from the loaded image's alpha values, should be rendered.
        ...
        /// <summary>
        /// Redraws the IImageMaskSurface using the alpha values of the image in the given IImageMaskSurface using the given padding and options.
        /// </summary>
        /// <param name="imageMaskSurface">IImageMaskSurface whose image's alpha values are to be used to create the mask.</param>
        /// <param name="padding">
        /// The padding between the IImageMaskSurface outer bounds and the bounds of the area where the mask, created from the loaded image's alpha values, should be rendered.
        ...
        /// <summary>
        /// Resizes and redraws the IImageMaskSurface using the alpha values of the image in the given IImageMaskSurface with the given padding and options.
        /// </summary>
        /// <param name="imageMaskSurface">IImageMaskSurface whose image's alpha values are to be used to create the mask.</param>
        /// <param name="size">New size of the IImageMaskSurface.</param>
        /// <param name="padding">
        ...
        /// <summary>
        /// Resizes the IImageMaskSurface with the given size and loads the image from the new Uri and uses its alpha values to redraw the IImageMaskSurface with the given padding using the given options.
        /// </summary>
