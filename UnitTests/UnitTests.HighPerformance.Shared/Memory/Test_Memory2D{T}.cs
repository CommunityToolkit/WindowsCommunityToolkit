...
namespace UnitTests.HighPerformance.Memory
{
    ...
    public class Test_Memory2DT
    {
        ...
        public void Test_Memory2DT_Array1DConstructor()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 1, 2, 2, 1);
        ...
        public void Test_Memory2DT_Array2DConstructor_1()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array);
        ...
        public void Test_Memory2DT_Array2DConstructor_2()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 0, 1, 2, 2);
        ...
        public void Test_Memory2DT_Array3DConstructor_1()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 1);
        ...
        public void Test_Memory2DT_Array3DConstructor_2()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 1, 0, 1, 2, 2);
        ...
        public void Test_Memory2DT_MemoryConstructor()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(memory, 1, 2, 2, 1);
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Memory2D<int>(memory, -99, 1, 1, 1));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Memory2D<int>(memory, 0, -10, 1, 1));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Memory2D<int>(memory, 0, 1, 1, -1));
        ...
        public void Test_Memory2DT_Slice_1()
        {
            ...
            Memory2D<int> slice1 = span2d.Slice(1, 1, 1, 2);
            ...
            Memory2D<int> slice2 = span2d.Slice(0, 1, 2, 2);
        ...
        public void Test_Memory2DT_Slice_2()
        {
            ...
            Memory2D<int> slice1 = span2d.Slice(0, 0, 2, 2);
        ...
        public void Test_Memory2DT_TryGetMemory_1()
        {
            ...
            bool success = span2d.TryGetMemory(out Memory<int> memory);
        ...
        public void Test_Memory2DT_TryGetMemory_2()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 2, 2);
        ...
        public void Test_Memory2DT_TryGetMemory_3()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(data, 2, 2);
        ...
        public void Test_Memory2DT_ToArray_2()
        {
            ...
            Memory2D<int> span2d = new Memory2D<int>(array, 0, 0, 2, 2);
        ...
        public void Test_Memory2DT_Equals()
        {
            ...
            Assert.IsFalse(span2d.Equals(new Memory2D<int>(array, 0, 1, 2, 2)));
            Assert.IsTrue(span2d.Equals(new Memory2D<int>(array)));
