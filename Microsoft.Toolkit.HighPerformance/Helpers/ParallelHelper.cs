...
namespace Microsoft.Toolkit.HighPerformance.Helpers
{
    ...
    public static class ParallelHelper
    {
        ...
        /// <typeparam name="TAction">The type of action (implementing <see cref="IAction{T}"/> of <typeparamref name="TItem"/>) to invoke over each item.</typeparam>
        ...
        public static void ForEach<TItem, TAction>(
            ...
            where TAction : struct, IAction<TItem>
        {
            ...
            where TAction : struct, IAction<TItem>
        {
            ...
            var actionInvoker = new ActionInvoker<TItem, TAction>(memory, action, batchSize);
        ...
        private readonly struct ActionInvoker<TItem, TAction>
            where TAction : struct, IAction<TItem>
        {
    ...
    /// <summary>
    /// A contract for actions being executed on items of a specific type.
    /// </summary>
