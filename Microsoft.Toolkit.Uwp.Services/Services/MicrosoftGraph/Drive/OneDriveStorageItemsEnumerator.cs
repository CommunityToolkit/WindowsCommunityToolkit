        ...
        public OneDriveStorageItem CurrentItem
        {
            get
            {
                try
                {
                    ...
                    {
                        return new OneDriveStorageFile(currentItem.Provider, currentItem.Builder, currentItem.OneDriveItem);
                    }

                        return new OneDriveStorageFolder(currentItem.Provider, currentItem.Builder, currentItem.OneDriveItem);
                }
