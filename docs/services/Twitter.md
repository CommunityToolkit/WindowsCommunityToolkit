...
**Note**: Twitter and LinkedIn services already have their .NET Standard platform implementation.These interfaces are the NetFrameworkAuthenticationBroker, NetFrameworkPasswordManager, NetFrameworkStorageManager and NetFrameworkSignatureManager. 
