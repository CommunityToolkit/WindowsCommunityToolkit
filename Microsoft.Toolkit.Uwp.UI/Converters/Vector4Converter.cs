...
{
    /// <summary>
    /// Converter for converting string to <see cref="Vector4"/>
    /// </summary>
    public class Vector4Converter : TypeConverter
    {
        ...
        {
            if (destinationType != null && value is Vector4 instance)
            {
                if (destinationType == typeof(string))
                {
                    return $"{instance.X}, {instance.Y}, {instance.Z}, {instance.W}";
                }
            }
