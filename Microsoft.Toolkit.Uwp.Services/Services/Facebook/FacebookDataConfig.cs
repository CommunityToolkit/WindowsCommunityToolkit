...
namespace Microsoft.Toolkit.Uwp.Services.Facebook
{
    ...
    {
        /// <summary>
        /// Gets a predefined config to get user feed. The feed of posts (including status updates)
        /// and links published by this person, or by others on this person's profile
        /// </summary>
        public static FacebookDataConfig MyFeed => new FacebookDataConfig { Query = "/me/feed" };

        /// <summary>
        /// Gets a predefined config to show pages of which the user is administrator
        /// </summary>
        public static FacebookDataConfig MyPages => new FacebookDataConfig { Query = "/me/accounts" };
