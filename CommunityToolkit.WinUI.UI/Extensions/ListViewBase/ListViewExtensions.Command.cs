...
namespace CommunityToolkit.WinUI.UI
{
    ...
    {
        /// <summary>
        /// Attached <see cref="DependencyProperty"/> for binding an <see cref="global::System.Windows.Input.ICommand"/> to handle ListViewBase Item interaction by means of <see cref="Microsoft.UI.Xaml.Controls.ListViewBase"/> ItemClick event. ListViewBase IsItemClickEnabled must be set to true.
        /// </summary>
        ...
        /// </summary>
        /// <param name="obj">The <see cref="Microsoft.UI.Xaml.Controls.ListViewBase"/> to get the associated <see cref="ICommand"/> from</param>
        ...
        /// </summary>
        /// <param name="obj">The <see cref="Microsoft.UI.Xaml.Controls.ListViewBase"/> to associate the <see cref="ICommand"/> with</param>
