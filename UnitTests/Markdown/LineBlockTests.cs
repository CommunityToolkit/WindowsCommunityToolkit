...
World";
        ...
        {
            var l = new LineBlock(text.AsSpan());
            Assert.AreEqual(text.Replace("\r\n", string.Empty).Length, l.TextLength);
        }
