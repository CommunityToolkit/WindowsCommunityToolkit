...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
    ...
    [global::System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1501:Statement should not be on a single line", Justification = "Inline brackets are used to improve code readability with repeated null checks.")]
    ...
    [global::System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.NamingRules", "SA1306:Field names should begin with lower-case letter", Justification = "Only template parts start with a capital letter. This differentiates them from other fields.")]
    public partial class ColorPicker : Microsoft.UI.Xaml.Controls.ColorPicker
    {
        ...
        public ColorPicker()
        {
            ...
            this.DefaultStyleResourceUri = new Uri("ms-appx:///Microsoft.Toolkit.Uwp.UI.Controls.Input/Themes/Generic.xaml");
        ...
        private void UpdateColorControlValues()
        {
            ...
            if (this.isInitialized)
            {
                ...
                {
                    this.ColorSpectrumControl.HsvColor = new global::System.Numerics.Vector4()
                    {
        ...
        /// </summary>
        private void PreviewBorder_PointerPressed(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
        ...
        /// </summary>
        private void HexInputTextBox_KeyDown(object sender, Microsoft.UI.Xaml.Input.KeyRoutedEventArgs e)
        {
        ...
        /// This is used to trigger a re-evaluation of the color based on the TextBox value.
        /// </summary>
        private void ChannelTextBox_KeyDown(object sender, Microsoft.UI.Xaml.Input.KeyRoutedEventArgs e)
        {
            if (e.Key == Windows.System.VirtualKey.Enter)
            {
