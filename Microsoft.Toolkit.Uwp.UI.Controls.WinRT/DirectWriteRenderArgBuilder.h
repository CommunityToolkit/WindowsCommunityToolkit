...
namespace winrt::Microsoft_Toolkit_Uwp_UI_Controls_WinRT::implementation
{
    ...
    public:
        ...
        /// <summary>
        void SetFontFamily(Windows::UI::Xaml::Media::FontFamily const& fontFamily);
        ...
        /// <summary>
        void SetTextLocale(winrt::hstring const& textLocale);

        /// <summary>
        /// The foreground brush, Black by default
        /// <summary>
        void SetForegroundBrush(Windows::UI::Xaml::Media::Brush const& brush);
    ...
    private:
        void BuildFontCollection(const winrt::hstring& fontFamily);
