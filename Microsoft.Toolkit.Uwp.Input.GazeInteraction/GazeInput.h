...
public:
    ...
    /// </summary>
    static DependencyProperty InteractionProperty();

    /// <summary>
    /// Identifyes the IsCursorVisible dependency property
    /// </summary>
    static DependencyProperty IsCursorVisibleProperty();

    /// <summary>
    /// Identifyes the CursorRadius dependency property
    /// </summary>
    static DependencyProperty CursorRadiusProperty();

    /// <summary>
    /// Identifyes the GazeElement dependency property
    /// </summary>
    static DependencyProperty GazeElementProperty();

    /// <summary>
    /// Identifyes the FixationDuration dependency property
    /// </summary>
    static DependencyProperty FixationDurationProperty();

    /// <summary>
    /// Identifies the DwellDuration dependency property
    /// </summary>
    static DependencyProperty DwellDurationProperty();

    /// <summary>
    /// Identifies the RepeatDelayDuration dependency property
    /// </summary>
    static DependencyProperty RepeatDelayDurationProperty();

    /// <summary>
    /// Identifies the DwellRepeatDuration dependency property
    /// </summary>
    static DependencyProperty DwellRepeatDurationProperty();

    /// <summary>
    /// Identifies the ThresholdDuration dependency property
    /// </summary>
    static DependencyProperty ThresholdDurationProperty();

    /// <summary>
    /// Identifies the MaxDwellRepeatCount dependency property
    /// </summary>
    static DependencyProperty MaxDwellRepeatCountProperty();

    /// <summary>
    /// Identifyes the IsSwitchEnabled dependency property
    /// </summary>
    static DependencyProperty IsSwitchEnabledProperty();

    /// <summary>
    /// Gets or sets the brush to use when displaying the default indication that gaze entered a control
    /// </summary>
    static Brush DwellFeedbackEnterBrush();
    static void DwellFeedbackEnterBrush(Brush);

    /// <summary>
    /// Gets or sets the brush to use when displaying the default animation for dwell press
    /// </summary>
    static Brush DwellFeedbackProgressBrush();
    static void DwellFeedbackProgressBrush(Brush);

    /// <summary>
    /// Gets or sets the brush to use when displaying the default animation for dwell complete
    /// </summary>
    static Brush DwellFeedbackCompleteBrush();
    static void DwellFeedbackCompleteBrush(Brush);

    /// <summary>
    /// Gets or sets the thickness of the lines animated for dwell.
    /// </summary>
    static double DwellStrokeThickness();
    static void DwellStrokeThickness(double);

    /// <summary>
    /// Gets or sets the interaction default
    /// </summary>
    static GazeInteraction::Interaction Interaction();
    static void Interaction(GazeInteraction::Interaction);
