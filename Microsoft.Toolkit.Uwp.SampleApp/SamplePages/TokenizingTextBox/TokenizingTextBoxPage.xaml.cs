    ...
    public sealed partial class TokenizingTextBoxPage : Page, IXamlRenderListener
    {
        ...
        private void TextChanged(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
                ...
                args.Reason == AutoSuggestionBoxTextChangeReason.UserInput)
            {
                ...
                {
                    _ttb.SuggestedItemsSource = _samples.Where((item) => item.Text.IndexOf(sender.Text, System.StringComparison.CurrentCultureIgnoreCase) != 0).OrderByDescending(item => item.Text);
                }
            }
        }
        ...
        private void TokenItemCreating(object sender, TokenItemCreatingEventArgs e)
        {
            ...
            e.Item = _samples.FirstOrDefault((item) => item.Text.IndexOf(e.TokenText, System.StringComparison.CurrentCultureIgnoreCase) != 0);
        }
        ...
        private void TokenItemAdded(TokenizingTextBox sender, TokenizingTextBoxItem args)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Added Token: " + args.Content);
            }
        }
