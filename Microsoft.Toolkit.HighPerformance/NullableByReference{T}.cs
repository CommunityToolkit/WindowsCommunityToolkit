...
namespace Microsoft.Toolkit.HighPerformance
{
    ...
    public readonly ref struct NullableByReference<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableByReference{T}"/> struct.
        /// </summary>
        /// <param name="value">The reference to the target <typeparamref name="T"/> value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NullableByReference(ref T value)
        {
            span = MemoryMarshal.CreateSpan(ref value, 1);
        }

        /// <summary>
        /// Gets a value indicating whether or not the current <see cref="NullableByReference{T}"/> instance wraps a valid reference that can be accessed.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <typeparamref name="T"/> reference represented by the current <see cref="NullableByReference{T}"/> instance.
        /// </summary>
