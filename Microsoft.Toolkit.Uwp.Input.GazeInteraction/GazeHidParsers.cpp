...
namespace GazeHidParsers {
    static HidNumericControlDescription  GetGazeUsageFromCollectionId(
        ...
        unsigned short childUsageId,
        unsigned short parentUsageId)
    {
...
#pragma region GazeHidPositionParser
    GazeHidPositionParser::GazeHidPositionParser(GazeDevicePreview  gazeDevice, unsigned short usage)
    {
        _usage = usage;
...
#pragma region GazeHidRotationParser
    GazeHidRotationParser::GazeHidRotationParser(GazeDevicePreview  gazeDevice, unsigned short usage) :
        _usage (usage),
    ...
    GazeHidPosition GazeHidRotationParser::GetRotation(const HidInputReport& report)
    {
        GazeHidPosition result;
...
#pragma region GazeHidPositionsParser
    GazeHidPositionsParser::GazeHidPositionsParser(GazeDevicePreview  gazeDevice) :
        _leftEyePositionParser (gazeDevice, (USHORT)GazeHidUsages::Usage_LeftEyePosition),
        _rightEyePositionParser(gazeDevice, (USHORT)GazeHidUsages::Usage_RightEyePosition),
        _headPositionParser(gazeDevice, (USHORT)GazeHidUsages::Usage_HeadPosition),
        _headRotationParser(gazeDevice, (USHORT)GazeHidUsages::Usage_HeadDirectionPoint)
    {
    }

    GazeHidPositions  GazeHidPositionsParser::GetGazeHidPositions(HidInputReport  report)
    {
        GazeHidPositions retval;
