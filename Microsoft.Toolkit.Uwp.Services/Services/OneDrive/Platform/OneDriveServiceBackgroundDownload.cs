...
namespace Microsoft.Toolkit.Uwp.Services.OneDrive.Platform
{
    ...
    /// </summary>
    public class OneDriveServiceBackgroundDownload : IOneDriveServiceBackgroundDownload
    {
        private Toolkit.Services.OneDrive.OneDriveService _service;

        /// <summary>
        /// Initializes a new instance of the <see cref="OneDriveServiceBackgroundDownload"/> class.
        /// </summary>
        /// <param name="service">Instance of OneDriveService</param>
        public OneDriveServiceBackgroundDownload(Toolkit.Services.OneDrive.OneDriveService service)
        {
            _service = service;
        }
