...
namespace Microsoft.Toolkit.Uwp.UI.Media
{
    ...
    public class CanvasPathGeometry : CanvasCoreGeometry
    {
        ...
        /// <summary>
        /// Gets or sets the path data for the associated Win2d <see cref="CanvasGeometry"/> defined in the Win2d Path Mini Language.
        /// </summary>
        public string Data
        {
        ...
        /// <summary>
        /// Parses the Path data string and converts it to <see cref="CanvasGeometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Parses the given Brush data string and converts it to <see cref="ICanvasBrush"/>.
        /// </summary>
        ...
        /// <summary>
        /// Parses the given Stroke data string and converts it to <see cref="ICanvasStroke"/>.
        /// </summary>
        /// <param name="resourceCreator"><see cref="ICanvasResourceCreator"/>.</param>
        ...
        /// <summary>
        /// Parses the give CanvasStrokeStyle data string and converts it to <see cref="CanvasStrokeStyle"/>.
        /// </summary>
        /// <param name="styleData"><see cref="CanvasStrokeStyle"/> data in string format.</param>
        ...
        /// <summary>
        /// Converts the color string in Hexadecimal or HDR color format to the corresponding <see cref="Color"/> object.
        ...
        /// <summary>
        /// Converts a Vector4 High Dynamic Range Color to <see cref="Color"/> object.
