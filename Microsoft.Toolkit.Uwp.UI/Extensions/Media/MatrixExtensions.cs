...
namespace Microsoft.Toolkit.Uwp.UI.Extensions
{
    ...
    public static class MatrixExtensions
    {
        ...
        {
            return MatrixHelper.FromElements(matrix.M11, matrix.M12, matrix.M21, matrix.M22, matrix.OffsetX + offsetX, matrix.OffsetY + offsetY);
        }
        ...
        internal static Matrix CreateRotationRadians(double angle, double centerX, double centerY)
        {
            ...
            return MatrixHelper.FromElements(cos, sin,
                              -sin, cos,
                              dx, dy);
        ...
        {
            #pragma warning disable SA1117 // Parameters must be on same line or separate lines
            return MatrixHelper.FromElements(scaleX, 0,
                              0, scaleY,
                              0, 0);
            #pragma warning restore SA1117 // Parameters must be on same line or separate lines
        }
        ...
        {
            #pragma warning disable SA1117 // Parameters must be on same line or separate lines
            return MatrixHelper.FromElements(1.0, Math.Tan(skewY),
                              Math.Tan(skewX), 1.0,
                              0.0, 0.0);
            #pragma warning restore SA1117 // Parameters must be on same line or separate lines
        }
